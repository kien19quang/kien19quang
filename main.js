  ...
  slogans: [
    {
      ...
      slogan:
        "Những gì bạn có được sau khi đạt mục tiêu không quan trọng bằng bạn trở thành người thế nào sau khi đạt được điều đó",
    },
    {
      img: "./assets/img/Mark_Zuckerberg.jpg",
      name: "Mark Zuckerberg",
      slogan:
        "Di chuyển nhanh và phá vỡ các quy tắc. Nếu vẫn chưa phá vỡ cái gì thì chính tỏ bạn vẫn chưa đủ nhanh",
    },
    {
    ...
    },
    {
      ...
      name: "Jack Ma",
      slogan:
        "Không có chuyện vừa làm ngày hôm nay, bạn đã thành công ngày mai. Hãy nhớ nếu kinh doanh hôm nay, bạn sẽ thành công sau 10 năm nữa",
    },
    {
    ...
    const htmls = this.slogans.map((slogan, index) => {
      return `
                <span class="selection ${
                  index === this.currentIndex ? "selection-active" : ""
